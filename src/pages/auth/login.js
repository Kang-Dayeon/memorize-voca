    ...
    <div className="login">
      <div className="login__wrap">
        ...
        <form className="login__form">
          <input name="loginId" value={value.loginId} onChange={setValue} type="text" placeholder="write your ID" />
          <input name="password" value={value.password} onChange={setValue} type="password" placeholder="write your password" />
